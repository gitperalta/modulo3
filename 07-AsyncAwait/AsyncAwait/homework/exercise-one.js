...
function problemA() {
  ...
  let readAsyncFile = async (file) => {
    blue(await promisifiedReadFile(file));
  };

  readAsyncFile("poem-one/stanza-01.txt");
}
...
function problemB() {
  ...
  readAsyncFile("poem-one/stanza-02.txt");
  readAsyncFile("poem-one/stanza-03.txt");
}
...
function problemC() {
  ...
  let readAsyncFilesInOrder = async (file1, file2) => {
    blue(await promisifiedReadFile(file1));
    blue(await promisifiedReadFile(file2));
  };

  readAsyncFilesInOrder("poem-one/stanza-02.txt", "poem-one/stanza-03.txt");
}
...
function problemD() {
  ...
  readAsyncFile("poem-one/wrong-file-name.txt");
}
